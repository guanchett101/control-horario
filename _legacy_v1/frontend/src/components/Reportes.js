          ...
          <>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: '600', color: '#111827' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: '600', color: totales.diasIncompletos > 0 ? '#ef4444' : '#111827' }}>
                  {totales.diasIncompletos}
                </div>
              </div>
            </div>
